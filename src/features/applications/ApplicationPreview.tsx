...
export function ApplicationPreview({studyNct}: { studyNct: string }) {
	...
	return (
		<Textarea
			...
			disabled
			value={
			`I hope this message finds you well. My name is ${values.firstName} ${values.lastName}, and I am writing to express my strong interest in participating in your upcoming clinical trial ${studyNct}.
